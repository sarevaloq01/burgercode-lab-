pipeline {
    ...
    stages {
        ...
        stage('Test (Control de Calidad)') {
            steps {
                ...
                // Ejecutamos el test dentro de la imagen para asegurar el entorno
        ...
        stage('Deploy (Entrega)') {
            steps {
                ...
                // Borra el contenedor anterior si existe para evitar errores
    ...
    // Bloque post para asegurar la limpieza y notificaciones finales
    post {
        always {
